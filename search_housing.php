                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="index.php" method="post" id="form1">
                                                <?php
                                                    echo "<input  type='hidden' name='place_search' id='place_search1' value =".$preference['destination']." >";
                                                    echo "<input  type='hidden' name='price_search_min' id='price_search_min1' value =".$preference['price_min']." >";
                                                    echo "<input  type='hidden' name='price_search_max' id='price_search_max1' value =".$preference['price_max']." >";
                                                    echo "<input  type='hidden' name='distance_search' id='distance_search1' value =".$preference['distance']." >";
                                                ?>
