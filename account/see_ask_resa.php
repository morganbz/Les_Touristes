...
<select class="form-select" aria-label="Default select example" name = 'order' id="order" onchange="window.location.href = (!(window.location.href.includes('&order='))) ? window.location.href.concat(this.value) : (window.location.href).substr(0, (window.location.href).indexOf('&order=')).concat(this.value)">
<?php
                        ...
                        <td>
                            ...
                            if($nbNotes > 0){
                                if($nbNotes == 1){
                                    ...
                                    echo $demand["note"]."/5 (".$nbNotes." notes)";
                                }
                            }
                            else{
                                echo "N/A";
